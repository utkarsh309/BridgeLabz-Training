...
It includes hands-on Java practice, problem-solving exercises, scenario-based implementations, and LeetCode solutions.

The repository is updated regularly to maintain a clear and transparent record of learning and development.
...
- Maintain a structured audit trail of coding work  
...
- Installed Java JDK 21 and verified the setup using the command line.
- Learned Java execution flow (`.java → .class → JVM`).
...
This repository serves as a continuous record of my learning journey and demonstrates:

- Daily commitment to coding practice  
- Progressive skill development  
- Real-world problem-solving ability using Java  
